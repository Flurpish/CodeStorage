...
0s and 1s, which is why you see those super cringe hacking scenes in movies use a buch of **binary** when it's absolutely pointless.
...
This language is refered to as machine language, or **binary**. It's the lowest-level programming language, basically meaning that there's infinite possibilies
...
with programming languages. This was mentioned previously, but programming langauges are basically the bridge between human readable language and a machines 
...
>> Now, I need to talk about how these languages are compiled and interperted and blah blah https://www.codeconquest.com/what-is-coding/how-does-coding-work/
